...
export const PlantCard = ({ plant, className }: PlantCardProps) => {
  return (
    <div className={`glass-card group relative ${className}`}>
      ...
      <div className="absolute top-3 right-3 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-out">
        <button className="bg-card/90 p-2 rounded-full shadow-lg hover:bg-card text-destructive">
          <Heart size={16} />
        </button>
      </div>
